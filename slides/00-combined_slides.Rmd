...
- We're not recording the 'lectures' or live-coding, but there's already an __excellent [series of videos on YouTube]("https://www.youtube.com/watch?v=t6IIJEoqPyk&list=PLRPB0ZzEYegPa4uvvAVJnr6loSKbN4wLb")__ covering how to use `ggplot2`
...
- Erm, the __dataset__ you're plotting!
...
- Tell `ggplot` __which variable(s)__ to facet by using `~`
