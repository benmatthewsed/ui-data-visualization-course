...
# `Your turn!`
# Lines __XXX__ in the [exercises](https://github.com/benmatthewsed/ui-data-visualization-course/blob/master/script/exercises.R)
# Lines __XXX__ in the [answers](https://github.com/benmatthewsed/ui-data-visualization-course/blob/master/script/exercises-with-answers.R)
...
---
# Bad plot challenge
1. Make the 'worst' plot you can based on the SIMD data (you can decide what makes the plot bad) 
2. Email their finished plots to me (Ben)
