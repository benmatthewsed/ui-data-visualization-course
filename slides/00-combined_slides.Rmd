...
- If you want to set colourto a single value, you can use `colour = "#123456"` using the colour [hex-code](https://www.color-hex.com/) or the [name of one of the colours `R` recognises](http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)
.pull-left[
...
- There are __some important ones__ we won't talk about today, like changing __text size__
...
- My most common uses are with __dates and times__
